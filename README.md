...
* [angular-cookie](https://github.com/angular/bower-angular-cookies)
...
`OAuthTokenProvider` uses [angular-cookies](https://github.com/angular/bower-angular-cookies) to store the cookies. Check the [available options](https://code.angularjs.org/1.4.0-beta.6/docs/api/ngCookies/service/$cookies).
